...
// 输出字节到硬件端口中
extern void outportb(u16, char);
// 从指定硬件端口读入一个字节
extern char inportb(u16);
...
extern char inportb(u16);		 // 读8255函数
extern void outportb(u16, char); // 写8255函数
